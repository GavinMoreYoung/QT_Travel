...
# Form implementation generated from reading ui file 'untitledSC.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(130, 80, 171, 20))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.pushButton = QtWidgets.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(130, 160, 75, 23))
        self.pushButton.setObjectName("pushButton")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(60, 120, 221, 21))
